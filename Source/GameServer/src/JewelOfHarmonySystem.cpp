...
//	GS-N	2.00.05	JPN	0x00571D60	-	Completed
//////////////////////////////////////////////////////////////////////
...
void CJewelOfHarmonySystem::_InitOption()
{
	...
	this->m_bSystemPrutiyJewel				= GetPrivateProfileInt(HARMONY_HDR,"PurityHarmonyJewel",0,HARMONY_FILE_PATH);
	this->m_bSystemMixSmeltingStone			= GetPrivateProfileInt(HARMONY_HDR,"MixSmeltingStoneItem",0,HARMONY_FILE_PATH);
	this->m_bSystemRestoreStrengthen		= GetPrivateProfileInt(HARMONY_HDR,"RestoreStrengthenItem",0,HARMONY_FILE_PATH);
	this->m_bSystemStrengthenItem			= GetPrivateProfileInt(HARMONY_HDR,"StrengthenItem",0,HARMONY_FILE_PATH);
	this->m_bSystemSmeltingItem				= GetPrivateProfileInt(HARMONY_HDR,"SmeltItemBySmeltingStone",0,HARMONY_FILE_PATH);

	this->m_iRatePuritySuccess				= GetPrivateProfileInt(HARMONY_HDR,"PuritySuccessRate",0,HARMONY_FILE_PATH);
	this->m_iZenForPurity					= GetPrivateProfileInt(HARMONY_HDR,"PurityNeedZen",0,HARMONY_FILE_PATH);
	this->m_iRateMixSmeltingStoneNor		= GetPrivateProfileInt(HARMONY_HDR,"SmeltingStoneSuccesRateNormal",0,HARMONY_FILE_PATH);
	this->m_iRateMixSmeltingStoneExt		= GetPrivateProfileInt(HARMONY_HDR,"SmeltingStoneSuccesRateExcellent",0,HARMONY_FILE_PATH);
	this->m_iZenForMixSmeltingStone			= GetPrivateProfileInt(HARMONY_HDR,"SmeltingNeedZen",0,HARMONY_FILE_PATH);
	this->m_iRateStrengthenSuccess			= GetPrivateProfileInt(HARMONY_HDR,"StrengthenSuccessRate",0,HARMONY_FILE_PATH);
	this->m_iRateSmeltingSuccessNor			= GetPrivateProfileInt(HARMONY_HDR,"SmeltingItemSuccessRateNormal",0,HARMONY_FILE_PATH);
	this->m_iRateSmeltingSuccessExt			= GetPrivateProfileInt(HARMONY_HDR,"SmeltingItemSuccessRateExcellent",0,HARMONY_FILE_PATH);
}

BOOL CJewelOfHarmonySystem::LoadScript(const char* lpszFileName)
{
	SMDToken Token;
...
BOOL CJewelOfHarmonySystem::LoadScriptOfSmelt(const char* lpszFileName)
{
	SMDToken Token;
	SMDFile = fopen(lpszFileName, "r");
...
void CJewelOfHarmonySystem::SetEnableToUsePuritySystem(BOOL bEnable)
{
	...
	CLog.LogAdd("[JewelOfHarmony][PuritySystem] Enable %d", bEnable);
}

...
bool GMJoinServerConnect(LPSTR ConnectServer, DWORD wMsg)
{
	...
	// -----
	CLog.Connect("LoginServer IP-Address: (%s) Port: (%d)", ConnectServer, Port[1]);
	// -----
	return TRUE;
}
// -----------------------------------------------------------------------------------------------------------------------------------------
bool GMRankingServerConnect(char* RankingServer, DWORD wMsg)
{
	...
	if (!bResult) 
		return FALSE;
	// -----
	CLog.Connect("RankingServer IP-Address: (%s) Port: (%d)", RankingServer, Port[5]);
	// -----
	return TRUE;
}
// -----------------------------------------------------------------------------------------------------------------------------------------
bool GMEventChipServerConnect(char* ServerIP, DWORD wMsg)
{
	...
	if (!bResult) 
		return FALSE;
	// -----
	CLog.Connect("EventChipServer IP-Address: (%s) Port: (%d)", ServerIP, Port[6]);
	// -----
	return TRUE;
}
// -----------------------------------------------------------------------------------------------------------------------------------------
...
bool ExDataServerConnect(char* ConnectServer, DWORD wMsg)
{
	...
	CLog.Connect("ExDB IP-Address: (%s) Port: (%d)", ConnectServer, Port[4]);
	// -----
	return TRUE;
}
// -----------------------------------------------------------------------------------------------------------------------------------------

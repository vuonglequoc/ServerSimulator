...
// GS-N	2.00.05	JPN	0x00593630	-	Completed
//////////////////////////////////////////////////////////////////////

#include "../Header Files/stdafx.h"
#include "../Header Files/CashLotterySystem.h"
#include "../Header Files/LargeRand.h"
...
void CCashLotterySystem::Load(const char* pchFilename)
{
	this->Initialize();
	...
	if ( SMDFile == NULL )
	{
		CLog.MsgBox("[CashLoterrySystem] Lottery Item List load failed. [%s]", pchFilename);
		return;
	}
...
int CCashLotterySystem::GetItem(CItem *lpItem)
{
	...
	CLog.LogAdd("[CashItem][LotteryItem] Get Item Category:%d,Index:%d (Name:%s,Type:%d,Index:%d,Level:%d) Skill:%d,Luck:%d,AddOption:%d,ExOption(%d,%d,%d,%d,%d,%d)",

...
#include "../Header Files/WZScriptEncode.h"

// GS-N 0.99.60T // 48c100 Status : Completed 2007-4-30
//	GS-N	2.00.05	JPN	0x004A7270	-	Completed
//	GS-CS	2.00.05	JPN	0x004A7270	-	Completed
...
enum WZSMDToken CWZScriptEncode::GetToken()
{
	...
	case 0x39:	//9
		...
		*p = 0;
		this->TokenNumber = (float)atof(TempString);

...
//	GS-N	2.00.05	JPN	0x00508C40	-	Completed
//	GS-CS	2.00.05	JPN	0x00508C40	-	Completed
//////////////////////////////////////////////////////////////////////
...
void CItemAddOption::Load(const char* chFileName)
{
	SMDToken Token;
		...
		if ( Token == NUMBER )
		{
			...
			while ( true )
			{
				...
				if ( iType == 1 )
				{
					...
					{
						CLog.MsgBox("[ItemAddOption] Overflow ItemAddOption Table Index");
					}
				}
				else if ( iType == 2 )
				{
